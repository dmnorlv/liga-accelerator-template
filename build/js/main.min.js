...
var initAccordeon = function initAccordeon() {
  if (document.querySelectorAll('.main-footer__heading-container') && document.querySelector('.main-footer__sections-wrapper') && document.querySelector('.main-footer__contacts-wrapper')) {
    ...
    if (footerButtons) {
      headingContainers.forEach(function (button, i) {
  ...
  window.addEventListener('load', function () {
    ...
    if (window.innerWidth < 768) {
      if (document.querySelectorAll('.main-footer__heading-container')) {
        var buttons = document.querySelectorAll('.main-footer__heading-container');
      ...
      var _buttons = document.querySelectorAll('.main-footer__heading-container');
      _buttons.forEach(function (element) {
